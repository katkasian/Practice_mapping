...
def main():
    ap = argparse.ArgumentParser(description='A script to create a random baseline for a dataset.')
    ap.add_argument('-i', '--input_file', required=True, help='Path to file from which to construct a random baseline')
