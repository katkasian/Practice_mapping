    ...
    try:
        response = client.chat.completions.create(
            ...
            messages=[
                ...
                -In your response, ONLY use the name of the practice and do not explain any reasoning. Return only one name from this list: [Advocacy, Arguing, Boundary policinng, Celebration, Coordination of assistance, Denouncing, Expressing solidarity, Fundraising, Knowledge performance, News and content curation, Personal anecdote, Self-criticism, Self-promotion, Not applicable]
                '''},
            ...
            #Ref: [Advocacy, Arguing, Boundary policinng, Celebration, Coordination of assistance, Denouncing, Expressing solidarity, Fundraising, Knowledge performance, News and content curation, Personal anecdote, Self-criticism, Self-promotion, Not applicable]
            temperature=0,
            max_tokens=10,
            top_p=1.0,
...
if __name__ == '__main__':
    ...
    for data in validation_dataset.iterrows():
        ...
        result = call_openai_chat("gpt-4o-mini", prompt_text)
